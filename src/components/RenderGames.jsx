...
const RenderGames = ({ genresName }) => {
  const [state, dispatch, { fetchData, selectGenres }] = useAppContext();
  ...
  return (
    <Container>
      <Container>
        <Row>
          <Col style={{ fontSize: 40, fontWeight: 700 }}>Action Game</Col>
        </Row>
      </Container>
      <Filter />
      <Container style={{ paddingTop: 20 }}>
        <InfiniteScroll
          ...
          next={() => {
            fetchData(), dispatch(actions.increasePage());
          }}
          hasMore={true}
